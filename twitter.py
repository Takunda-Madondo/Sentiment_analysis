...
class TwitterClient(object):
    ...
    def __init__(self, query, retweets_only=False, with_sentiment=False):
        ...
        consumer_key ="SfdzU6sjzitd2a3j0lGm2XjsW"
        consumer_secret = "trL7kgMcqRdFS1A499HYnUx0G2SbqjMNkcQolyoMNMtjvBe4dS"
        access_token = "1404774633778429961-HO9qs4OFdiz87nHkxi4X1CoUHHvRqX"
        access_token_secret ="T7zbBEgrdhvYv1lSbVfeZfBEnAVmvzo1JdWMjcrePyBSQ"
